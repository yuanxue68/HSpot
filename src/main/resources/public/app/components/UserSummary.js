...
export default class UserSummary extends Component{
	...
	render(){
		...
		return(
			<div className="row">
				<div className="col-md-2 recommended"></div>
				<div className="col-md-10">
					<div className="user-summary-container">
						...
						<div className="user-summary-info">
							...
							<div><span>Description: </span> <span className="grey-font">{this.props.user.description && this.props.user.description.length>230? this.props.user.description.substring(0,230)+"..." : this.props.user.description}</span></div>
						</div>
					</div>
				</div>
			</div>
